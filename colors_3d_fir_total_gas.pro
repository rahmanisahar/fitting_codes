pro colors_3d_fir_total_gas
  filename6= '~/Desktop/project/result/res_from_sharcnet/bayes/diff_region/18kpc_25kpc/ES/fir_vs_tot/M31data.csv'
  filename3= '~/Desktop/project/result/res_from_sharcnet/bayes/diff_region/8kpc_18kpc/ES/fir_vs_tot/M31data.csv'
  filename2= '~/Desktop/project/result/res_from_sharcnet/bayes/diff_region/8kpc/ES/fir_vs_tot/M31data.csv'
...
;    zTITLE= '$\Sigma_{stars}$ (M$\odot$ pc$^{-2}$)',$
  ...
  pp=plot3d([max(logindep),min(logindep)],$
    [max(logindep),min(logindep)]*0.47+[max(logstar),min(logstar)]*0.69-10.44,[max(logstar),min(logstar)],$
...
;    zTITLE= '$\Sigma_{stars}$ (M$\odot$ pc$^{-2}$)',$
  ...
  fit=plot3d([max(logindep),min(logindep)],$
    [max(logindep),min(logindep)]*0.63+[max(logstar),min(logstar)]*0.53-10.63,[max(logstar),min(logstar)],$
