pro colors_3d_fir_H2
  filename6= '~/Desktop/project/result/res_from_sharcnet/bayes/diff_region/18kpc_25kpc/ES/fir_vs_H2/M31data.csv'
  filename3= '~/Desktop/project/result/res_from_sharcnet/bayes/diff_region/8kpc_18kpc/ES/fir_vs_H2/M31data.csv'
  filename2= '~/Desktop/project/result/res_from_sharcnet/bayes/diff_region/8kpc/ES/fir_vs_H2/M31data.csv'
  
  readcol,filename6,v1,logindep,v3,logstar,v5,logdep,v7
  x=fltarr(n_elements(v7))+1.5
  ...
  p=plot3d(logindep,logdep,logstar,'6',$
    ...
    AXIS_STYLE=2,$
    ;LINESTYLE=1,$
    DEPTH_CUE=[0, 2], /PERSPECTIVE,ZRANGE=[min(logstar)-2,max(logstar)+2],XRANGE=[-1.5,1.5],yRANGE=[-11,-7], $
  ...
  fit1=plot3d([max(logindep),min(logindep)],$
    [max(logindep),min(logindep)]*0.97+[max(logstar),min(logstar)]*1.19-10.94,[max(logstar),min(logstar)],$
  ...
  pp=plot3d([max(logindep),min(logindep)],$
    [max(logindep),min(logindep)]*1.00+[max(logstar),min(logstar)]*0.40-9.66,[max(logstar),min(logstar)],$
  ...
  fit=plot3d([max(logindep),min(logindep)],$
    [max(logindep),min(logindep)]*0.88+[max(logstar),min(logstar)]*0.30-9.54,[max(logstar),min(logstar)],$
