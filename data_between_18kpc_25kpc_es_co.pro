pro data_between_18kpc_25kpc_es_co
  ...
  err_sfr=mrdfits('~/Desktop/project/proms/h2/reg_to_co/err_sfr_fuv_reg_co_sb.fits',0)
  ...
  good = where( ell gt arcsec_of_18kpc and ell lt arcsec_of_25kpc )   ;gt 8kpc and lt 18kpc
