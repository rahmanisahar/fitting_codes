pro colors_3d_fir_hi
  filename6= '~/Desktop/project/result/res_from_sharcnet/bayes/diff_region/18kpc_25kpc/ES/fir_vs_hi/M31data.csv'
  filename3= '~/Desktop/project/result/res_from_sharcnet/bayes/diff_region/8kpc_18kpc/ES/fir_vs_hi/M31data.csv'
  ...
  fit1=plot3d([max(logindep),min(logindep)],$
    [max(logindep),min(logindep)]*0.76+[max(logstar),min(logstar)]*0.75-10.72,[max(logstar),min(logstar)],$
  ...
  pp=plot3d([max(logindep),min(logindep)],$
    [max(logindep),min(logindep)]*0.77+[max(logstar),min(logstar)]*0.74-10.71,[max(logstar),min(logstar)],$
  ...
  fit=plot3d([max(logindep),min(logindep)],$
    [max(logindep),min(logindep)]*0.47+[max(logstar),min(logstar)]*1.57-12.11,[max(logstar),min(logstar)],$
